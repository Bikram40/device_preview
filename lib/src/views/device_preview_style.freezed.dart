...
mixin _$DevicePreviewButtonsVisibilityStyleData {
  ...
  Function get onBack => throw _privateConstructorUsedError;
...
class _$_DevicePreviewButtonsVisibilityStyleData
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'DevicePreviewButtonsVisibilityStyleData(togglePreview: $togglePreview, device: $device, onBack: $onBack, back: $back, language: $language, rotate: $rotate, toggleFrame: $toggleFrame, toggleKeyboard: $toggleKeyboard, darkMode: $darkMode, accessibility: $accessibility, settings: $settings)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('onBack', onBack))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _DevicePreviewButtonsVisibilityStyleData &&
            ...
            (identical(other.onBack, onBack) ||
                const DeepCollectionEquality().equals(other.onBack, onBack)) &&
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(onBack) ^
